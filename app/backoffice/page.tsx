...
export default function BackofficePage() {
  ...
  const handleGenerarComprobante = (comprador: Comprador) => {
    if (!sorteoActual) return
    generarComprobante(comprador, sorteoActual.titulo_remera, () => {
      toast({
                          ...
                          {(() => {
                            ...
                            return gratuitos > 0 ? (
                              <p className="text-xs text-emerald-600 mt-1">
                                🍀 {gratuitos} gratuito
                                {gratuitos === 1 ? "" : "s"} ·{" "}
                                {estadisticas.totalCompradores - gratuitos} de
                                pago
                              </p>
                            ) : null
                          })()}
                          ...
                          <TableRow key={comprador.id}>
                            ...
                            <TableCell>
                              <div className="flex flex-col gap-2">
                                <Button
                                  onClick={() => handleGenerarComprobante(comprador)}
                                  variant="outline"
                                  size="sm"
                                  className="w-full"
                                >
                            ...
                            <TableRow key={comprador.id}>
                              ...
                              <TableCell>
                                <div className="flex flex-col gap-2">
                                  <Button
                                    onClick={() =>
                                      handleGenerarComprobante(comprador)
                                    }
                                    variant="outline"
                                    size="sm"
                                    className="w-full"
